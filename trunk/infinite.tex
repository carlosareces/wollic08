...
\tb{(Diego) Los siguientes resultados deberian ir en la seccion de expresividad \\ (Sergio) Les parece? a mi me parece bien que esten aca, en la sección de epresividad lo veo un poco descolgado}
...
\begin{pf}
Straightforward from $\cMLRKME \leq \cMLRKE$
